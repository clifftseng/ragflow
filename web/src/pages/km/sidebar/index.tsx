...
export function SideBar({ refreshCount }: PropType) {
  ...
  if (!data?.id) {
    console.log('%c[RAGFLOW-DEBUG] SideBar: No data.id found, rendering loading state.', 'color: #f39c12');
    return <aside className="relative p-5 space-y-8"><div>Loading Sidebar...</div></aside>;
  }
