...
export default {
  ...
  // public KM
  km_update_kb: `${api_host}/km/update`,
  ...
  km_token: (kb_id: string) => `${api_host}/km/token?kb_id=${kb_id}`,
  ...
  km_retrieval_test: `${api_host}/km/retrieval_test`,
  km_list_tags: `${api_host}/km/tags`,
  km_list_tags_by_kb: (kb_id: string) => `${api_host}/km/${kb_id}/tags`,
  km_rm_tags: (kb_id: string) => `${api_host}/km/${kb_id}/rm_tags`,
  km_rename_tag: (kb_id: string) => `${api_host}/km/${kb_id}/rename_tag`,
  ...
  kmSearchDetail: `${api_host}/km_search/detail`,
  kmSearchAsk: `${api_host}/km_search/ask`,
  kmSearchMindmap: `${api_host}/km_search/mindmap`,
  kmSearchRelatedQuestions: `${api_host}/km_search/related_questions`,
  kmSearchRetrievalTest: `${api_host}/km_search/retrieval_test`,
